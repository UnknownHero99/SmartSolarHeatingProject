...
String menulogedin = "<div id='menu'><ul><li><a href=\"?cmd=Pump(mainPump, On)\">Vklopi črpalko</a></li><li><a href=\"?cmd=Pump(mainPump, Off)\">Izklopi črpalko</a></li><li><a href=\"?cmd=Pump(mainPump, Auto)\">Avtomatično</a></li><li><a href='/'>Status</a></li><li><a href='/settings'>Nastavitve</a></li><li><a href='/graphs'>Grafi</a></li><li><a href='/login?DISCONNECT=YES'>Odjava</a></li></ul></div></div><div id='content_Wrapper'><div id='content'>";
